                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="id_departamento" class="form-control form-control-sm" name="Consultorio[Departamento]" onchange="getMunicipios();" >
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select id="id_municipios" class="form-control form-control-sm" name="Consultorio[Municipio]" >
                                    <option value="">Seleccione...</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control form-control-sm" name="Consultorio[Direccion]" value="">	
                            </div>
                        </div>
